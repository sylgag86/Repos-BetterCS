          ...
          {featuredLenders.map((lender, index) => (
            ...
            >
              <div className="p-6">
                ...
                <Link href={lender.link}>
                  <a className={`block w-full py-3 text-center rounded-lg ${lender.buttonClass || 'bg-primary hover:bg-primary/90'} text-white font-semibold transition-colors`}>
                    Apply Now
                  </a>
                </Link>
